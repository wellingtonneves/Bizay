...
WebUI.setText(findTestObject('Object Repository/CheckoutPT/Page_Iniciar sesso/input__UserName'), 'd1syone@gmail.com')
...
WebUI.click(findTestObject('Object Repository/CheckoutPT/Page_PromoPrice 10,71 , PromoDiscount 48,29/div_INICIAR COMPRA'))
