...
WebUI.setText(findTestObject('LoginNewUser - Variable/Page_Iniciar sesso/input__UserName'), 'dcilurzo1@gmail.com')

WebUI.setEncryptedText(findTestObject('LoginNewUser - Variable/Page_Iniciar sesso/input__Password'), 'aeHFOx8jV/A=')
